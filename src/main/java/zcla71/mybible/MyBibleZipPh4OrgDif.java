...
public class MyBibleZipPh4OrgDif extends MyBibleZip {
    private Map<String, String> SIGLA_REPLACE_MAP = null; // inicializado em padronizaSigla()

    public MyBibleZipPh4OrgDif() throws Exception {
        super(new URI("https://www.ph4.org/_dl.php?back=bbl&a=DIF&b=mybible&c"), "ph4_org_DIF");
    }
