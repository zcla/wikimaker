...
public class MyBibleZipPh4OrgDbfc extends MyBibleZip {
    private Map<String, String> SIGLA_REPLACE_MAP = null; // inicializado em padronizaSigla()

    public MyBibleZipPh4OrgDbfc() throws Exception {
        super(new URI("https://www.ph4.org/_dl.php?back=bbl&a=DBFC&b=mybible&c"), "ph4_org_DBFC");
    }
